...
if(isset($_REQUEST['add']) || isset($_SESSION['subject']) ){
	
		if($_REQUEST['subject'] || ($_SESSION['subject'])){
...
<body>
 ...
 <nav>
    ...
    <div class="nav-wrapper blue">
      <div class="row">
                               <img hspace="20" align="left" src="logo.png" width='50' height='50'>
	...
	<div class="col s4">
			  ...
			  <div class="card hoverable">
    				<div class="card-image waves-effect waves-block waves-light">
      					<img class="activator" src="images/addnew.png">
    				</div>
...
<div class="col s4">
  <div class="card hoverable">
  	  <div class="card-image waves-effect waves-block waves-light">
    	  <img class="activator" src="images/genn.png">
      </div>
      <div class="card-content">
...
<div class="col s4">
  <div class="card hoverable">
  	  <div class="card-image waves-effect waves-block waves-light">
    	  <img class="activator" src="images/editnew.png">
      </div>
      <div class="card-content">
  ...
  <div class="card hoverable">
  	  <div class="card-image waves-effect waves-block waves-light">
    	  <img class="activator" src="images/prevn.png">
      </div>
      <div class="card-content">
  ...
  <div class="card hoverable">
  	  <div class="card-image waves-effect waves-block waves-light">
    	  <img class="activator" src="images/syllab.png">
      </div>
      <div class="card-content">
  ...
  <div class="card hoverable">
      ...
      <div class="card-content">
      		<span class="card-title activator grey-text text-darken-4">Logout of the System<i class="material-icons right">more_vert</i></span>
      		<p><button class="btn waves-effect waves-light blue" type="submit" name="logout" id="logout">Logout
    		<i class="material-icons right">send</i>
 			 </button>
      </div>
    <div class="card-reveal">
