    ...
    <div class="nav-wrapper blue">
      <div class="row">
        ...
        <div class="col s6 offset-s3">
         <a href="#" align="center">Question Paper Generator : Admin Reports</a></div>
<div col="col s4">
 ...
 <div class="row blue">
    <div class="col s12 blue">
      <ul class="tabs white">
        <li class="tab col s6 blue  hoverable"><a class="active white-text" href="#test1">Home
</a></li>
        <li class="tab col s6 blue"><a class="active white-text" href="#test2">Developers</a></li>
        <li class="tab col s6 blue" ><a class="active white-text" href="#test3">Guidelines</a></li>
        <li class="tab col s6 blue"><a class="active white-text" href="#test4">About Us</a></li>
...
<div class="col s4">
  <div class="card hoverable">
      ...
      <div class="card-content">
      		<span class="card-title activator grey-text text-darken-4">LOD Composition<i class="material-icons right">more_vert</i></span>
      		<p><button class="btn waves-effect waves-light blue" type="button" name="lod" id="lod" onClick="location.href='chartjs/bargraph.php'">Proceed
    		<i class="material-icons right">send</i>
 			 </button>
      </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">LOD Composition<i class="material-icons right">close</i></span>
      <p>Generate report to check how the questions in the database are distributed across different LOD</p>
    </div>
  </div>
  </div>
...
<div class="col s4">
  <div class="card hoverable">
      ...
      <div class="card-content">
      		<span class="card-title activator grey-text text-darken-4">Subject Composition<i class="material-icons right">more_vert</i></span>
      		<p><button class="btn waves-effect waves-light blue" type="button" id="CO" name="co" onClick="location.href='chartjs2/bargraph.html'">proceed
    		<i class="material-icons right">send</i>
 			 </button>
      </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Subject Composition<i class="material-icons right">close</i></span>
      <p>Generate report to check how many questions are there in each subject</p>
    </div>
  </div>
  </div>
  ...
  <div class="card hoverable">
      ...
      <div class="card-content">
      		<span class="card-title activator grey-text text-darken-4">Login/Update History<i class="material-icons right">more_vert</i></span>
      		<p><button class="btn waves-effect waves-light blue" type="button" id="log" name="log" onClick="location.href='histrep.php'">Proceed
    		<i class="material-icons right">send</i>
 			 </button>
      </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Login/Update History<i class="material-icons right">close</i></span>
      <p>Generate login and update history of the portal</p>
    </div>
  </div>
  </div>
  ...
  <div class="card hoverable">
      ...
      <div class="card-content">
      		<span class="card-title activator grey-text text-darken-4">Subject-Teachers<i class="material-icons right">more_vert</i></span>
      		<p><button class="btn waves-effect waves-light blue" type="button" name="teach" id="teach" onClick="location.href='teachsub.php'">Get reports
    		<i class="material-icons right">send</i>
 			 </button>
      </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Subject-Teachers<i class="material-icons right">close</i></span>
      <p>Generate reports as to which teacher is handling which course</p>
    </div>
  </div>
  </div>
  ...
  <div class="card hoverable">
      ...
      <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">Dashboard<i class="material-icons right">more_vert</i></span>
          <p><button class="btn waves-effect waves-light blue" type="button" name="back" id="teach" onClick="location.href='admindash.php'">Go back
        <i class="material-icons right">send</i>
       </button>
      </div>
    <div class="card-reveal">
      <span class="card-title grey-text text-darken-4">Go back<i class="material-icons right">close</i></span>
